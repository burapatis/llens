...
export const metadata: Metadata = {title:"Self-Assessment Center | LearnerLens",description:"ประเมินความพร้อมด้านความเข้าใจผู้เรียน ห้องเรียนแบบเรียนรวม และการสอนที่ยืดหยุ่น พร้อม Radar Chart",alternates:{canonical:"/assessment"},openGraph:{title:"Self-Assessment Center | LearnerLens",description:"ประเมินตนเองและเลือกก้าวพัฒนา",url:"/assessment",images:[]},twitter:{title:"Self-Assessment Center | LearnerLens",description:"ประเมินตนเองสำหรับครู",images:[]}};
