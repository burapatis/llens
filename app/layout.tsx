...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const structuredData = { "@context":"https://schema.org", "@type":"WebSite", name:"LearnerLens", alternateName:"เข้าใจผู้เรียน", url:"https://learnerlens-th.burapatis.chatgpt.site", description:"แพลตฟอร์มความรู้และเครื่องมือสำหรับครู เพื่อเข้าใจความแตกต่างของผู้เรียน", inLanguage:"th", author:{"@type":"Person",name:"Boorapatis Ploysuwan",jobTitle:"ผู้วิจัยอิสระ",email:"burapatis@gmail.com",image:"https://learnerlens-th.burapatis.chatgpt.site/images/boorapatis-ploysuwan.jpg"}, potentialAction:{"@type":"SearchAction",target:"https://learnerlens-th.burapatis.chatgpt.site/?q={search_term_string}","query-input":"required name=search_term_string"} };
