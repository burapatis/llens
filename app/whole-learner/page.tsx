...
const dimensions = [
  { id:"development", number:"01", icon:"◒", title:"ร่างกายและพัฒนาการ", subtitle:"BODY & DEVELOPMENT", observe:"การนอน พลังงาน การเคลื่อนไหว การมองเห็น–ได้ยิน สุขภาพ และทักษะที่เหมาะกับช่วงวัย", ask:"ช่วงไหนของวันที่เรียนได้ดีที่สุด? มีอะไรทำให้เหนื่อยหรือไม่สบาย?", tone:"blue" },
  { id:"learning", number:"02", icon:"◇", title:"การคิดและการเรียนรู้", subtitle:"COGNITION & LEARNING", observe:"ความรู้เดิม ความเข้าใจผิด ภาษา ความจำ จังหวะประมวลผล วิธีแก้ปัญหา และการถ่ายโอนความรู้", ask:"ทำอะไรได้เอง ทำอะไรได้เมื่อมีตัวช่วย และติดตรงขั้นตอนไหน?", tone:"teal" },
  { id:"executive", number:"03", icon:"↗", title:"สมาธิและการกำกับตนเอง", subtitle:"ATTENTION & EXECUTIVE FUNCTIONS", observe:"การเริ่มงาน จดจ่อ เปลี่ยนงาน วางแผน ยับยั้งชั่งใจ จัดอุปกรณ์ และติดตามเวลา", ask:"เงื่อนไขใดช่วยให้เริ่มและทำต่อได้? ตัวช่วยใดใช้ได้จริง?", tone:"violet" },
  { id:"motivation", number:"04", icon:"✦", title:"ความสนใจและแรงจูงใจ", subtitle:"INTEREST & MOTIVATION", observe:"สิ่งที่ชอบ จุดแข็ง เป้าหมาย ความหมาย ความท้าทายที่พอดี ทางเลือก และความเป็นเจ้าของการเรียน", ask:"อะไรทำให้ตาเป็นประกาย? เรื่องใดที่อยากทำต่อแม้ไม่มีใครบังคับ?", tone:"amber" },
  { id:"emotion", number:"05", icon:"◎", title:"อารมณ์และความเชื่อมั่น", subtitle:"EMOTION & SELF-BELIEF", observe:"ความรู้สึกปลอดภัย ความเครียด การรับมือความผิดพลาด Self-efficacy Growth Mindset และสัญญาณทุกข์ใจ", ask:"เมื่อยากหรือผิดพลาด เด็กพูดกับตนเองอย่างไร และกลับมาได้ด้วยอะไร?", tone:"rose" },
  { id:"relationships", number:"06", icon:"∞", title:"ความสัมพันธ์และการเป็นส่วนหนึ่ง", subtitle:"RELATIONSHIPS & BELONGING", observe:"ความไว้วางใจกับครู เพื่อน การร่วมมือ การสื่อสาร ขอบเขต บทบาทในกลุ่ม การยอมรับและการบูลลี่", ask:"อยู่กับใครแล้วเป็นตัวเองได้? เมื่อมีปัญหา เด็กขอความช่วยเหลือจากใคร?", tone:"teal" },
  { id:"identity", number:"07", icon:"◉", title:"อัตลักษณ์ ภาษา และวัฒนธรรม", subtitle:"IDENTITY, LANGUAGE & CULTURE", observe:"ภาษาที่ใช้ ประสบการณ์ วัฒนธรรม เพศ ความเชื่อ คุณค่า ความภาคภูมิใจ และวิธีสื่อสารที่ครอบครัวคุ้นเคย", ask:"มีส่วนใดของตัวตนที่เด็กอยากให้ครูรู้ และมีสิ่งใดที่ห้องเรียนยังมองไม่เห็น?", tone:"violet" },
  { id:"context", number:"08", icon:"⌂", title:"ครอบครัว บริบท และการเข้าถึง", subtitle:"FAMILY, CONTEXT & ACCESS", observe:"กิจวัตร ผู้ดูแล ภาระที่บ้าน ทรัพยากร เทคโนโลยี การเดินทาง พื้นที่เรียน เหตุการณ์เปลี่ยนแปลง และอุปสรรคในระบบ", ask:"นอกห้องเรียนมีอะไรช่วยหรือขัดขวาง และโรงเรียนเปลี่ยนเงื่อนไขใดได้บ้าง?", tone:"blue" },
];

const evidenceSteps = [
  ["เห็น", "สังเกตพฤติกรรมที่มองเห็นและได้ยิน บอกเวลา สถานที่ งาน และสิ่งที่เกิดก่อน–หลัง"],
  ["ฟัง", "ถามผู้เรียนด้วยคำถามเปิด ให้เวลา และเคารพสิทธิที่จะยังไม่เล่าบางเรื่อง"],
  ["ดูผลงาน", "เปรียบเทียบชิ้นงาน วิธีคิด ความก้าวหน้า และเงื่อนไขที่ช่วยให้ทำได้"],
  ["เชื่อมบริบท", "รับฟังครอบครัว ครูคนอื่น และผู้เกี่ยวข้องเท่าที่จำเป็น โดยรักษาความเป็นส่วนตัว"],
];
  ...
  return <SubPage eyebrow="WHOLE LEARNER MAP" title="เข้าใจเด็กหนึ่งคน ต้องมองให้เห็นทั้งคน" description="พฤติกรรมหรือคะแนนเป็นเพียงร่องรอยหนึ่ง ใช้แผนที่ 8 มิตินี้เพื่อมองหาจุดแข็ง ความต้องการ ความสัมพันธ์ และบริบท—ก่อนออกแบบการช่วยเหลือ">
    <section className="whole-learner-page" id="top">
      ...
      <section className="whole-evidence" aria-labelledby="evidence-title">
        <div className="whole-section-heading"><span className="section-kicker left">TRIANGULATE EVIDENCE</span><h2 id="evidence-title">เข้าใจลึกขึ้น เมื่อไม่มองจากสายตาครูเพียงด้านเดียว</h2><p>ดูรูปแบบที่เกิดซ้ำในหลายเวลา หลายงาน และหลายบริบท พร้อมให้เสียงผู้เรียนมีน้ำหนักในการตีความ</p></div>
        <ol>{evidenceSteps.map((step,index)=><li key={step[0]}><span>{String(index+1).padStart(2,"0")}</span><div><strong>{step[0]}</strong><p>{step[1]}</p></div></li>)}</ol>
      </section>
