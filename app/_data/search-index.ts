...
export const searchItems: SearchItem[] = [
  ...
  { title: "แผนที่เข้าใจผู้เรียนทั้งคน", description: "ภาพรวม 8 มิติที่ครูควรสังเกตเพื่อเข้าใจเด็กอย่างลึกซึ้ง รอบด้าน และไม่รีบติดป้าย", href: "/whole-learner", category: "เครื่องมือ", keywords: ["เข้าใจเด็ก", "สังเกตผู้เรียน", "ทั้งคน", "พัฒนาการ", "อารมณ์", "บริบท", "ความสัมพันธ์", "แรงจูงใจ"] },
  ...
  { title: "เรียนรู้ตามจังหวะในปฐมวัย", description: "ใช้ของจริง สาธิตทีละขั้น ให้เวลารอ และเก็บหลักฐานหลายบริบทก่อนสรุป", href: "/cases#early-learning-pace", category: "กรณีศึกษา", keywords: ["เรียนรู้ช้า", "พัฒนาการ", "อนุบาล", "ปฐมวัย", "ตอบช้า"] },
  { title: "ช่วงเปลี่ยนผ่านและสมาธิในปฐมวัย", description: "ใช้ตารางภาพ การเตือนล่วงหน้า การเคลื่อนไหว และกิจกรรมช่วงสั้น", href: "/cases#early-transition-attention", category: "กรณีศึกษา", keywords: ["สมาธิสั้น", "ซุกซน", "ลุกเดิน", "อนุบาล", "ปฐมวัย"] },
  { title: "คิดได้เมื่อไม่ถูกเร่ง", description: "แยกความเข้าใจคณิตศาสตร์ออกจากความเร็วและภาระของความจำ", href: "/cases#primary-processing-time", category: "กรณีศึกษา", keywords: ["เรียนช้า", "ประมวลผลช้า", "คณิตศาสตร์", "ทำไม่ทัน", "ประถม"] },
  { title: "เข้าใจบทเรียนแต่พลาดคำสั่ง", description: "แบ่งงานเป็นช่วง ให้ feedback และใช้เครื่องมือกำกับตนเองโดยไม่รีบติดป้าย", href: "/cases#primary-attention-support", category: "กรณีศึกษา", keywords: ["สมาธิสั้น", "ADHD", "ลืมงาน", "คุยแทรก", "ประถม"] },
  { title: "ความสนใจเรื่องไดโนเสาร์เป็นสะพาน", description: "รักษาความลึกของความสนใจ พร้อมขยายความยืดหยุ่นและการสนทนากับเพื่อน", href: "/cases#primary-intense-interest", category: "กรณีศึกษา", keywords: ["สนใจเรื่องเดียว", "ความสนใจเฉพาะ", "ศักยภาพ", "ไดโนเสาร์", "ประถม"] },
  { title: "ไม่ทันสังเกตว่าเพื่อนยังไม่ได้พูด", description: "สอนการผลัดกันพูด ขอความยินยอม และแยกผลกระทบออกจากการตัดสินเจตนา", href: "/cases#primary-social-reciprocity", category: "กรณีศึกษา", keywords: ["ไม่สนใจคนอื่น", "พูดคนเดียว", "เพื่อน", "ทักษะสังคม", "ประถม"] },
  { title: "จดจ่อความสนใจเดียวจนงานอื่นไม่เดิน", description: "ใช้ Deep Work จุดเปลี่ยนงาน และขยายความสนใจโดยไม่พรากสิ่งที่ผู้เรียนรัก", href: "/cases#secondary-hyperfocus", category: "กรณีศึกษา", keywords: ["hyperfocus", "สนใจเรื่องเดียว", "หมกมุ่น", "รถไฟ", "มัธยม"] },
  { title: "เล่นเกมดึกจนง่วงและงานตก", description: "สำรวจหน้าที่ของเกมและผลต่อการนอน ก่อนทดลองแผนสมดุลร่วมกับผู้เรียน", href: "/cases#secondary-gaming-sleep", category: "กรณีศึกษา", keywords: ["ติดเกม", "เล่นเกม", "นอนดึก", "หลับใน", "มัธยม"] },
  { title: "ส่งเรื่องที่ชอบซ้ำจนเพื่อนปิดกลุ่ม", description: "ฝึกขอบเขต ความยินยอม และสร้างพื้นที่สมัครใจสำหรับความสนใจร่วม", href: "/cases#secondary-peer-boundaries", category: "กรณีศึกษา", keywords: ["ไม่สนใจคนอื่น", "เพื่อน", "กลุ่มแชต", "ความสนใจเฉพาะ", "มัธยม"] },
  { title: "สมาธิและความปลอดภัยในงานช่าง", description: "ใช้รายการตรวจ จุดหยุด และ Buddy Check โดยไม่ลดมาตรฐานความปลอดภัย", href: "/cases#vocational-workshop-attention", category: "กรณีศึกษา", keywords: ["สมาธิ", "อาชีวศึกษา", "ปวช", "งานช่าง", "ความปลอดภัย"] },
  { title: "อ่านบทความไม่ทันในมหาวิทยาลัย", description: "จัดลำดับบทอ่าน ใช้ไฟล์เข้าถึงได้ และสอนกลยุทธ์อ่านโดยเคารพสิทธิผู้เรียนผู้ใหญ่", href: "/cases#higher-reading-load", category: "กรณีศึกษา", keywords: ["เรียนรู้ช้า", "อ่านช้า", "มหาวิทยาลัย", "อุดมศึกษา", "บทความ"] },
  { title: "เกมกับการกำกับโครงงานในมหาวิทยาลัย", description: "แบ่งงาน สร้าง If–Then Plan และเชื่อมบริการช่วยเหลือโดยรักษาความเป็นเจ้าของแผน", href: "/cases#higher-gaming-project", category: "กรณีศึกษา", keywords: ["ติดเกม", "มหาวิทยาลัย", "อุดมศึกษา", "ส่งงานช้า", "กำกับตนเอง"] },
