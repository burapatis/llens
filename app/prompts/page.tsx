...
export const metadata: Metadata = {title:"Prompt Library | LearnerLens",description:"Prompt สำหรับวิเคราะห์ผู้เรียน ออกแบบการเรียนรู้ สร้างกิจกรรม ประเมินผล และสะท้อนการสอน",openGraph:{title:"Prompt Library | LearnerLens",description:"Prompt พร้อมคัดลอกสำหรับครู",images:[]},twitter:{title:"Prompt Library | LearnerLens",description:"Prompt พร้อมคัดลอกสำหรับครู",images:[]}};
