...
export const metadata: Metadata = {
  ...
  openGraph: { title: "เครื่องมือวิเคราะห์ผู้เรียน | LearnerLens", description: "ค้นหาสัญญาณความสนใจและเปลี่ยนการสังเกตเป็นข้อมูลที่ใช้วางแผนการสอนได้", url: "/toolkit", images: [] },
